  ...
  app.get("/", async () => {
    ...
    return {
      items: [
        ...
        { id: "redesign", version: REDESIGN_PROMPT_V2.version, preview: "(Long. Multi-page JSON output, business-only content, studio overlay injected at deploy time, real scraped assets.)" },
